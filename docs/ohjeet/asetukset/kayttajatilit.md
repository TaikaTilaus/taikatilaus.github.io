---
sidebar_position: 7
description: Käyttäjätilit — Käyttäjien tietojen muokkaaminen.
---

# Käyttäjätilit

![Käyttäjätilit](/img/ohjeet/kayttajat.png)
*Pääkäyttäjät voivat hallinnoida palvelun käyttäjiä Käyttäjätilit-välilehdeltä.*

**Käyttäjätilit**-välilehdellä pääkäyttäjiksi nimetyt henkilöt voivat lisätä uusia sekä muokata ja poistaa olemassa olevia TaikaTilaus-palvelun käyttäjiä.
...
![Käyttäjätilit](/img/ohjeet/kayttajat5.png)
...
![Käyttäjätilit](/img/ohjeet/kayttajat2.png)
