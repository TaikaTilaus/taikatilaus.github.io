---
sidebar_position: 3
description: Vakioniput — Yksittäisten nippujen muokkaus, Nippujen päivitys.
---
...
**Vakioniput**-välilehdellä ylläpidetään vakionippujen rekisteriä, jossa listataan muun muassa:
...
![Vakioniput](/img/ohjeet/vakionippu2.png)
