...
**Tilausvahvistus**-painikkeesta voi lähettää asiakkaalle tilausvahvistuksen kirjeellä tai sähköpostitse. Voit myös esikatsella tilausvahvistuksen. Tilausvahvistuksen teksti määritellään <a href="/docs/ohjeet/asetukset/asiointipalvelut/viestipohjat">oletusasetuksien Viestipohjat-välilehdeltä</a>.
