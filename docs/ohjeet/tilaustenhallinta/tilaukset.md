...
**Tilausvahvistus**-painikkeesta voi lähettää asiakkaalle tilausvahvistuksen kirjeellä tai sähköpostitse. Voit myös esikatsella tilausvahvistuksen. Tilausvahvistuksen teksti määritellään <a href="/docs/ohjeet/asetukset/asiointikanavat/viestipohjat">oletusasetuksien Viestipohjat-välilehdeltä</a>.
